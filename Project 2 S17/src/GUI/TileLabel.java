...
public class TileLabel extends JLabel {
	...
	public static final Font FONT = new Font(Font.SANS_SERIF, 
			Font.BOLD, 36);
	/** Set smaller font */
	public static final Font SMALL_FONT = new Font(Font.SANS_SERIF, 
			Font.BOLD,
			24);
	 ...
	 **********************************************************/
	public void paintComponent(Graphics g) {//paint board different 
											//colors
		...
		g.drawString(str, getWidth() / 2 - str.length() * 
				font.getSize() / 2
				+ 8, getHeight() / 2 + 12);
	}
