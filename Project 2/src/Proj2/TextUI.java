...
public class TextUI {
	...
	public TextUI() {
		...
		if (game == null) {
			System.err
					.println("*---------------------------------------------*");
			System.err
					.println("| You must first modify the UI program.       |");
			System.err
					.println("| Look for the first TODO item in TextUI.java |");
			System.err
					.println("*---------------------------------------------*");
			System.exit(0xE0);
		}
	...
	/**
	 * The main loop for playing a SINGLE game session. Notice that the
	 * following method contains NO GAME LOGIC! Its main task is to accept user
	 * input and invoke the appropriate methods in the game engine.
	 */
	public void playLoop() {
		...
		/*
		 * To keep the right margin within 75 columns, we split the following
		 * long string literal into two lines
		 */
